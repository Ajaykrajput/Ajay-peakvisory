...
import { CopyClipIcon, UploadCloudIcon } from "../ui/atoms/Icons";
...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-xl my-auto mx-auto w-full bg-white p-6 rounded-xl shadow-md">
      ...
      {/* Upload Box */}
      <div className="border-dashed border-2 flex items-center justify-center h-32 border-gray-300 rounded-lg p-3 mt-4">
